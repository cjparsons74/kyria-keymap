...
/* #define T_GUI MT(MOD_LGUI, KC_F) */
    ...
    [_QWERTY] = LAYOUT(
      /* LT(KC_RALT, KC_ESC) */
      KC_MS_BTN2,              KC_Q,   KC_W,   KC_F,   KC_J,   KC_G,                                         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_PIPE,
      KC_LCTL,                 KC_A,   KC_R,   KC_S,   KC_T,   KC_D,                                         KC_H,    KC_N,    KC_E,    KC_L,    KC_SCLN, KC_QUOT,
